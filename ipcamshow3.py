...
class connect_to_database():
    ...
    def write_sql(self,lines):
        ...
        st= "INSERT INTO dbo.fishcatch VALUES('"+ran+"','"+lines[2]+"' , '"+'黃金測試號'+"' , '"+name+"' ,"+str(float(lines[4])*1.6)+","+lines[4]+",'"+"黃大胖"+"', '"+lines[5]+","+lines[6]+"','"+lines[0]+" "+lines[1]+"','"+str(911)+"','06-2757575#61207',0,"+lines[5]+","+lines[6]+",'"+lines[7]+"');"
        print(st)
