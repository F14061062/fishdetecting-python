...
class connect_to_database():
    ...
    def write_sql(self,lines):
        ...
        print(lines)
        ran=str(random.randint(10000,99999))+str(random.randint(10000,99999))+str(random.randint(10000,99999))+str(random.randint(0,9))
        ...
        st= "INSERT INTO dbo.fishcatch VALUES('"+ran+"','"+lines[3]+"' , '"+'黃金測試號'+"' , '"+lines[3]+"' ,"+str(187)+","+lines[4]+",'"+"黃大胖"+"', '"+lines[5]+","+lines[6]+"','"+lines[0]+" "+lines[1]+"','"+str(911)+"','06-2757575#61207',0,"+lines[5]+","+lines[6]+",'"+lines[7]+"');"
        print(st)
        ...
        def determin_the_length(head_position,tail_position,head_name,frame):
            ...
            for i in range(len(head_position)):
                ...
                if(len(boxx)!=0):
                    ...
                    at= time.strftime('%Y-%m-%d %H:%M:%S',result)
